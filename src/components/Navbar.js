...
import Bukhari from "../../public/assets/bukharilogo.png"
...
export default function Navbar() {
  ...
  return (
    <>
      <div>
        <nav className="section--light  px-9 flex justify-between items-center">
          <Image src={Bukhari} style={{ width: "223px" }} />
          <button
